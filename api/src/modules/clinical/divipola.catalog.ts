/**
 * DIVIPOLA (DANE): departamentos y municipios de Colombia con su código
 * oficial. Alimenta los selectores de residencia del paciente y el código
 * municipal que exige el archivo de usuarios de RIPS.
 */
export interface DivipolaMunicipality {
  /** Código DANE de 5 dígitos, p. ej. 17001 para Manizales. */
  code: string;
  name: string;
}

export interface DivipolaDepartment {
  /** Código DANE de 2 dígitos, p. ej. 17 para Caldas. */
  code: string;
  name: string;
  municipalities: DivipolaMunicipality[];
}

export const DIVIPOLA: DivipolaDepartment[] = [
  {
    code: '91',
    name: 'Amazonas',
    municipalities: [
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: '68235', name: 'El Carmen de Chucuri' },
